  ...
  return (
    <div className="flex-1 w-full h-screen">
      {!noChatSelected ? (
        ...
        <>
          <div className="relative bg-[url('https://i.redd.it/ts7vuoswhwf41.jpg')] bg-center bg-cover bg-no-repeat after:absolute after:w-full after:h-full after:top-0 after:left-0 after:z-10 after:bg-[#1D232A] after:bg-opacity-80 w-full h-screen">
